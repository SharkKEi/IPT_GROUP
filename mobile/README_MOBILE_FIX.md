...
- Auto-detects your Expo LAN IP and connects to Django at `http://YOUR_PC_IP:8000`.
...
If auto-detect fails, start Expo like this, replacing the IP with your PC Wi-Fi IPv4 address:
